...
set(GROMACS_CXX_STANDARD "${GMX_CXXSTD}" CACHE STRING "GROMACS C++ standard requirement")
...
if (GROMACS_LIBRARY)
    ...
    if(PC_GROMACS_CFLAGS_OTHER)
      ...
      endforeach(LIB)
		...
		# if ( NOT ("${GMX_DEP_LIBRARIES}" MATCHES "fftw3") AND ${PC_GROMACS_VERSION} VERSION_GREATER "4.6.0" AND ${PC_GROMACS_VERSION} VERSION_LESS "2024" )
		# 	find_library(FFTW fftw3f HINTS ${FFTW_LIB})
		# 	if (FFTW)
		# 		message(STATUS "Found fftw library: ${FFTW}")
		# 		list(APPEND GMX_DEP_LIBRARIES ${FFTW})
		...
		# 		message(FATAL_ERROR "\nFFTW library file libfftw3f.so or libfftw3f.a not found... \nUSE:\n -DFFTW_LIB=/path/to/fftw3/lib/    ")
		# 	endif(FFTW)
		# endif ( NOT ("${GMX_DEP_LIBRARIES}" MATCHES "fftw3") AND ${PC_GROMACS_VERSION} VERSION_GREATER "4.6.0" AND ${PC_GROMACS_VERSION} VERSION_LESS "2024" )

		if(${PC_GROMACS_VERSION} VERSION_EQUAL "5.0" OR ${PC_GROMACS_VERSION} VERSION_GREATER "5.0" AND ${PC_GROMACS_VERSION} VERSION_LESS "2024" )
		...
		endif(${PC_GROMACS_VERSION} VERSION_EQUAL "5.0" OR ${PC_GROMACS_VERSION} VERSION_GREATER "5.0" AND ${PC_GROMACS_VERSION} VERSION_LESS "2024" )
	...
	if(VERSION_LENGTH GREATER 1)
		...
		else(VERSION_LENGTH GREATER 2)
			set(GROMACS_PATCH_LEVEL 0)
		endif(VERSION_LENGTH GREATER 2)
	else(VERSION_LENGTH GREATER 1)
		set(GROMACS_MINOR_VERSION 0)
	endif(VERSION_LENGTH GREATER 1)
